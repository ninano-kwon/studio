...
팀구성: 
Team 1: 류민호 (AI GDE), 유의선 (GDG Golang Korea), 이의석 (GDG 캠퍼스), 조새벽 (GDG 인천)
...
Team 5: 김나연 (GDG 서울), 김마로 (GDG 인천), 이재규 (GDG Golang Korea), 이현우 (GDG 안드로이드)
Team 6: 한성민 (GDG, GDE Go/AI, Cloud, Go), 한상준 (GDG 인천), 정은지 (GDG 캠퍼스), 한우석 (GDG Golang Korea)
Team 7: 김대현 (GDG 캠퍼스), 김수현 (GDG 안드로이드), 유광무 (GDG 인천), 정현서 (GDG Golang Korea), 고은진 (GDG 판교)`,
  },
